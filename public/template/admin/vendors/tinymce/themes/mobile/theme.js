...
(function () {
    ...
    var parts$1 = constant([group({
        factory: {
          sketch: function (spec) {
            var itemInfo = asRawOrDie('category.spec item', itemSchema$1, spec);
    ...
    var focus$4 = constant('alloy.category-focus');
    ...
    var makeItem = function (value, text, selected, preview, isMenu) {
      return {
        ...
        dom: {
          tag: 'div',
          classes: isMenu ? [resolve('styles-item-is-category')] : []
        },
        toggling: {
          toggleOnExecute: false,
      ...
      return {
        ...
        components: [
          ...
          }),
          {
            dom: {
              tag: 'div',
              classes: [resolve('styles-category-items-container')]
            },
            components: [Menu.parts.items({})],
            behaviours: derive$1([config('adhoc-scrollable-category', [
    ...
    var sketch$8 = function (settings) {
      ...
      var memMenu = record(tieredMenu.sketch({
        dom: {
          tag: 'div',
          classes: [resolve('styles-category')]
        },
        components: [],
        fakeFocus: true,
        stayInDom: true,
        ...
        onOpenSubmenu: function (container, item, submenu) {
          var w = get$8(container.element);
          var menu = ancestor$2(item.element, '[role="category"]').getOrDie('hacky');
        ...
        onCollapseMenu: function (container, item, menu) {
          var submenu = ancestor$2(item.element, '[role="category"]').getOrDie('hacky');
        ...
        data: dataset.tmenu,
        markers: {
          backgroundMenu: resolve('styles-background-category'),
          menu: resolve('styles-category'),
          selectedMenu: resolve('styles-selected-category'),
