                                ...
                                <table class="table-shopping-cart">
                                    ...
                                    @foreach($products as $key => $product)
                                        ...
                                        <tr class="table_row">
                                            ...
                                            <td class="p-r-15">
                                                <a href="/carts/delete/{{ $product->id }}" onclick="return confirmDeletion();">
                                                    <div class="btn btn-danger bor14">Xóa</div>
                                                </a>
                                            </td>
                                        </tr>
                                    @endforeach
                            ...
                            <div class="flex-w flex-t bor12 p-t-15 p-b-30">
                                ...
                                <div class="size-100 p-r-18 p-r-0-sm w-full-ssm">
                                    ...
                                    <div class="p-t-15">
                                        ...
                                        <div class="bor8 bg0 m-b-12">
                                            <textarea class="cl8 plh3 size-111 p-lr-15" name="message"></textarea>
                                        </div>
